...
All scripts hosted in this repository are **public to use**. However, they are built with modern execution standards in mind and rely on standard environment functions.
...
## Compatibility & Executor Requirements
